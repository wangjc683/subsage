...
| 版本 | 亮点 |
|------|------|
| v0.4.5 | 登录态延长至 90 天（原 7 天）；修复 Chrome 密码自动填充（form action/method、input name 属性、history.replaceState 导航） |
| v0.4.4 | 修复总览页编辑订阅后状态不同步；订阅变更通过 store 机制自动刷新所有派生视图（统计、日历等） |
